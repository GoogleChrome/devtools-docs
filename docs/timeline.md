...
<ol>
    ...
    <ul>
        <li>Click the round record button at the bottom of the Timeline panel. <img style="vertical-align:middle" src="timeline-images/recordbutton-off.png"></img></li>
        <li>Press the keyboard shortcut Ctrl+E, or Cmd+E on Mac.
        </li>
    </ul>
    <p>The Record button turns red during a recording. <img src="timeline-images/recordbutton-on.png" style="vertical-align:middle"></img> </p>
