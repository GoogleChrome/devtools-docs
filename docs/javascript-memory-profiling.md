{{+bindTo:partials.standard_devtools_article canonical:strings.canonicalDevToolsMemoryProfiling}}
<p class="caution">
...
Remember that we mentioned earlier you can force GC from the DevTools as part of your snapshot workflow. When taking a Heap Snapshot, it is automatically forced. In Timeline it can be very convenient to force a GC by clicking on the trash can ( Garbage) button (<img src="../images/collect-garbage.png"/>).
